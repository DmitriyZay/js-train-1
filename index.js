...
// Задача 3: Напишіть функцію, яка перевіряє, чи є задане число простим(ділиться без остачі
//тільки на себе та на 1).
...
// Використовуйте умовний оператор if, else if та оператори
//порівняння для визначення статусу користувача.
...
// Задача 9: Напишіть функцію getDayOfWeek,
//яка приймає номер дня тижня dayNumber (1-7) і повертає рядок, що відповідає цьому дню тижня.
...
function getVariableType(variable) {
  ...
  if (typeof variable === "number") {
    return (info = "Це число");
  } else if (typeof variable === "string") {
    return (info = "Це рядок");
  } else if (typeof variable === "boolean") {
    return (info = "Це булеве значення");
  } else {
    return (info = "Це інший тип");
  }
}
